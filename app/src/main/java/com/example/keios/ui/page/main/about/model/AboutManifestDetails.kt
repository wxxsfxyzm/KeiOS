package com.example.keios.ui.page.main.about.model
...
private val componentExplainMap = mapOf(
    "com.example.keios.mcp.McpKeepAliveService" to AboutExplainRes(
    ...
    "com.example.keios.feature.notification.NotificationActionReceiver" to AboutExplainRes(
